...
/*CREATE DATABASE /*!32312 IF NOT EXISTS*//* `bookstore` ; */
...
CREATE TABLE `Publisher` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_mf05ettnsb50ssbfdo9rpruz6` (`addr_id`),
  CONSTRAINT `FK_mf05ettnsb50ssbfdo9rpruz6` FOREIGN KEY (`addr_id`) REFERENCES `Address` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Publisher` VALUES (1,'orders@kiko.com','Kiko Publishing, Inc.',NULL),(2,'admin@booksinc.com','Books Incorporated',NULL);
...
--
alter table OrderItem add column state varchar(10) default 'PENDING';
